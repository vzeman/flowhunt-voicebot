...
Latency metric signals include count, average, max, P50, and P90 so autoscaling
can react to tail latency rather than only mean latency. Operational SLOs and
support diagnostics are exposed through
