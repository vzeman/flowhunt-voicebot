...
class ApiWebRTCTests(unittest.TestCase):
    ...
    def test_webrtc_test_page_closes_on_backend_hangup_event(self) -> None:
        ...
        self.assertIn("detailCell.colSpan = 4", html)
        self.assertIn("renderJson(event.data)", html)
        self.assertIn("appendDetailTextRow(tableBody, summary, 4", html)
        self.assertIn("appendDetailTextRow(logNode, parsed.summary, 3", html)
