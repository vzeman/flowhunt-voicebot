...
class ApiWebRTCTests(unittest.TestCase):
    ...
    def test_webrtc_test_page_is_removed_from_standalone_routes(self) -> None:
        client, _manager = self.build_client(FakeWebRTCManager())
    ...
    def test_dashboard_contains_embedded_webrtc_console(self) -> None:
        client, _manager = self.build_client(FakeWebRTCManager())
        ...
        self.assertIn("showTestTab(button.dataset.testTab)", html)
        ...
        self.assertIn('aria-label=&quot;Widget chat preview&quot;', html)
        self.assertIn('aria-label=&quot;Subagent communication&quot;', html)
        self.assertIn('data-table-filter=&quot;log&quot;', html)
        self.assertIn('data-table-filter=&quot;event-log&quot;', html)
        self.assertIn('data-table-filter=&quot;transcript-log&quot;', html)
        self.assertIn('data-table-filter=&quot;chat-log&quot;', html)
        self.assertIn('data-table-filter=&quot;subagent-log&quot;', html)
        self.assertIn("applyTableFilter(tbodyId)", html)
        self.assertIn("Voicebot Events", html)
        self.assertIn("Call Transcript", html)
        self.assertIn("Widget Chat Preview", html)
        ...
        self.assertIn("suppressLocalAudioPlayback", html)
        self.assertIn("latency: {ideal: 0.01}", html)
        self.assertIn("echoCancellation: {ideal: true}", html)
        self.assertIn("message.startsWith(&quot;local audio settings=&quot;)", html)
        self.assertIn('class=&quot;test-tabs&quot;', html)
        self.assertIn('class=&quot;log-panel test-tab-panel active&quot;', html)
