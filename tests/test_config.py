...
class ConfigTests(unittest.TestCase):
    ...
    def test_voice_defaults_prefer_openai_stt_quality(self) -> None:
        ...
        self.assertEqual(settings.barge_in_threshold, 0.08)
        self.assertEqual(settings.echo_tail_ms, 300)
        self.assertEqual(settings.silence_ms, 450)
        self.assertEqual(settings.min_seconds, 0.35)
