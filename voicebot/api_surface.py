...
FLOWHUNT_API_SURFACE: tuple[ApiEndpointSpec, ...] = (
    ...
    ApiEndpointSpec("GET", "/subagent/providers", "task", "internal", workspace_scoped=False, scope_source="none", description="Inspect registered provider-neutral colleague task adapters."),
    ApiEndpointSpec("POST", "/subagent/tasks", "task", "internal", workspace_scoped=True, scope_source="payload", description="Submit provider-neutral delegated colleague work."),
    ApiEndpointSpec("POST", "/subagent/tasks/speculative", "task", "internal", workspace_scoped=True, scope_source="payload", description="Start cancellable speculative delegated colleague work."),
    ApiEndpointSpec("POST", "/subagent/tasks/{task_id}/confirm-speculative", "task", "internal", workspace_scoped=True, scope_source="payload", description="Confirm speculative colleague work from the final transcript."),
    ApiEndpointSpec("POST", "/subagent/tasks/{task_id}/cancel-speculative", "task", "internal", workspace_scoped=True, scope_source="payload", description="Cancel speculative colleague work before it can speak results."),
    ...
    ApiEndpointSpec("POST", "/operations/drain/start", "runtime", "internal", workspace_scoped=False, scope_source="none", description="Start runtime draining."),
    ApiEndpointSpec("POST", "/operations/drain/stop", "runtime", "internal", workspace_scoped=False, scope_source="none", description="Stop runtime draining."),
    ...
    ApiEndpointSpec("GET", "/scaling/session-ownership", "scaling", "internal", workspace_scoped=False, scope_source="none", description="Audit active sessions against current owner leases."),
    ApiEndpointSpec("GET", "/scaling/multi-worker-readiness", "scaling", "internal", workspace_scoped=False, scope_source="none", description="Report whether event IDs and active session ownership are safe for multiple workers."),
