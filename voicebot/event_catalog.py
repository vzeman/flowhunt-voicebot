...
EVENT_CATALOG: tuple[EventCatalogEntry, ...] = (
    ...
    EventCatalogEntry("turn_coalesced", "stt", "Short adjacent caller transcripts were merged for one agent request."),
    ...
    EventCatalogEntry("subagent_task_speculative_started", "agent_team", "Speculative delegated work started from stable partial intent."),
    EventCatalogEntry("subagent_task_speculative_confirmed", "agent_team", "Final caller transcript confirmed speculative delegated work."),
    EventCatalogEntry("subagent_task_speculative_cancelled", "agent_team", "Speculative delegated work was cancelled before confirmation."),
    EventCatalogEntry("subagent_task_speculative_superseded", "agent_team", "Speculative delegated work was superseded by a newer final request."),
