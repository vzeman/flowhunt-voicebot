...
EVENT_CATEGORIES: dict[str, TimelineCategory] = {
    ...
    "subagent_task_speculative_started": "task",
    "subagent_task_speculative_confirmed": "task",
    "subagent_task_speculative_cancelled": "task",
    "subagent_task_speculative_superseded": "task",
